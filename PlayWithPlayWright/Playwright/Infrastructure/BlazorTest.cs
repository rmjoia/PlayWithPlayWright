...
{
    protected static readonly LocatorAssertionsToBeVisibleOptions loadingSpinnerTimeout = new LocatorAssertionsToBeVisibleOptions() { Timeout = 10000 };
    ...
    public async Task BlazorSetup()
    {
        ...
        await Context.RouteAsync($"{RootUri.AbsoluteUri}**", async route =>
        {
            ...
            var content = request.PostDataBuffer is { } postDatabuffer ? new ByteArrayContent(postDatabuffer) : null;
